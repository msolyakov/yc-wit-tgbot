...
class HandlerTest(unittest.TestCase):
    ...
    def test_json_message_group(self):
    ...
    def test_json_Message_Audio(self):
    ...
    def test_json_Message_Sticker(self):
    ...
    def test_json_Message_Sticker_without_thumb(self):
    ...
    def test_json_Message_Document(self):
    ...
    def test_json_Message_Photo(self):
    ...
    def test_json_Message_Video(self):
    ...
    def test_json_Message_Location(self):
    ...
    def test_json_UserProfilePhotos(self):
    ...
    def test_InlineQueryResultCachedPhoto(self):
    ...
    def test_InlineQueryResultCachedPhoto_with_title(self):
    ...
    def test_InlineQueryResultCachedPhoto_with_markup(self):
